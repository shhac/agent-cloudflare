...
// the rest of agent-cloudflare keeps the internal/errors import path while the
...
type (
	...
	// APIError is the family name for the shared output.Error type. Its
	// WithHint/WithHints chaining methods come from the shared type.
	APIError = out.Error
)
